...
export default function TrustBridgeLogin() {
    ...
    const panelContent = {
        ...
        'success': { title: "You're signed in", sub: '' },
    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#f0f2f0] text-slate-900 font-sans">
            ...
            <div className="flex items-center justify-between p-4 md:px-6">
                ...
                <button onClick={signUpRedirect} className="bg-white text-[#0F5525] border-[1.5px] border-[#0F5525] rounded-lg px-4 py-1.5 text-[13px] font-medium transition-colors hover:bg-[#3FCD6B] hover:border-[#3FCD6B] hover:text-white">
                    Sign up
                </button>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-4 pb-6">
                <div className="bg-white rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.13),0_2px_8px_rgba(0,0,0,0.07)] w-full max-w-[370px] overflow-hidden">

                    <div className="pt-6 px-6 pb-4 md:pt-[30px] md:px-[28px] md:pb-[18px]">
                        <div className="text-[19px] font-semibold text-[#111] mb-1">{panelContent[activePanel].title}</div>
                        <div className="text-[13px] text-[#777]">{panelContent[activePanel].sub}</div>
                    </div>

                    <div className="px-6 pb-6 md:px-[28px] md:pb-[28px]">
                            ...
                            <div className="block">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-4">
                                    <button onClick={handleSuccess} className="flex items-center justify-center gap-2 py-2 px-2.5 rounded-lg border border-[#dde3e0] bg-white text-[13px] font-medium text-[#222] transition-colors hover:bg-[#3FCD6B] hover:border-[#3FCD6B] hover:text-white group">
                                        <svg width="15" height="15" viewBox="0 0 48 48" className="group-hover:opacity-90"><path d="M43.6 20.5H42V20H24v8h11.3C33.7 32.7 29.3 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.8 1.1 7.9 3l5.7-5.7C34.1 6.5 29.3 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20c11 0 20-9 20-20 0-1.2-.1-2.3-.4-3.5z" fill="#FFC107"/><path d="M6.3 14.7l6.6 4.8C14.7 16 19.1 13 24 13c3.1 0 5.8 1.1 7.9 3l5.7-5.7C34.1 6.5 29.3 4 24 4 16.3 4 9.7 8.3 6.3 14.7z" fill="#FF3D00"/><path d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2C29.4 35.5 26.8 36 24 36c-5.2 0-9.7-3.3-11.3-8H6.1C9.4 36.1 16.2 44 24 44z" fill="#4CAF50"/><path d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.2-4.1 5.6l6.2 5.2C37 38.9 44 33 44 24c0-1.2-.1-2.3-.4-3.5z" fill="#1976D2"/></svg>
                                        Google
                                    </button>
                                    <button onClick={handleSuccess} className="flex items-center justify-center gap-2 py-2 px-2.5 rounded-lg border border-[#dde3e0] bg-white text-[13px] font-medium text-[#222] transition-colors hover:bg-[#3FCD6B] hover:border-[#3FCD6B] hover:text-white group">
                                        <svg width="14" height="14" viewBox="0 0 814 1000" className="group-hover:invert"><path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-57.8-155.5-127.4C46 790.7 0 663 0 541.8c0-207.5 135.4-317.3 268.5-317.3 70.1 0 128.4 46.4 172.5 46.4 42.3 0 109.2-49.9 190.5-49.9 30.8 0 108.2 2.6 168.6 75.3zm-234.6-172.9c32.1-38.2 54.7-91.4 54.7-144.7 0-7.4-.6-14.9-1.9-21.1-51.9 2-113.1 34.7-149.5 78.2-28.2 32.8-55.3 85.4-55.3 139.4 0 8 1.3 16 1.9 18.6 3.2.6 8.4 1.3 13.6 1.3 46.4 0 102.9-31.5 136.5-71.7z" fill="#111"/></svg>
                                        Apple
                                    </button>
                                </div>
                            </div>
                        ...
                        {activePanel === 'success' && (
                            <div className="text-center py-3">
                                ...
                                <div className="text-[15px] font-semibold text-[#111] mb-1.5">You&#39;re signed in</div>
                        ...
                        {activePanel === 'magic-sent' && (
                            <div className="text-center py-3">
                                ...
                                <div className="text-[15px] font-semibold text-[#111] mb-1.5">Check your inbox</div>
