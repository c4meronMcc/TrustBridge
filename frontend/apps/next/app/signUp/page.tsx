    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#f0f2f0] text-slate-900 font-sans">
            ...
            <div className="flex items-center justify-between p-4 md:px-6">
                ...
                <button onClick={handleRedirectLogin} className="bg-white text-[#0F5525] border-[1.5px] border-[#0F5525] rounded-lg px-4 py-1.5 text-[13px] font-medium transition-colors hover:bg-[#3FCD6B] hover:border-[#3FCD6B] hover:text-white">
                    Login
                </button>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-4 pb-6">
                <div className="bg-white rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.13),0_2px_8px_rgba(0,0,0,0.07)] w-full max-w-sm overflow-hidden">
                    ...
                    {activePanel === 'login' && (
                        <div>
                            <div className="pt-5 px-6 pb-2">
                                <div className="text-[17px] font-semibold text-[#111] mb-0.5">Create your account</div>
                                <div className="text-[12px] text-[#777]">Join TrustBridge to start your journey</div>
                            </div>
                            ...
                            <div className="px-6 pb-5">
                                ...
                                <div className="grid grid-cols-2 gap-2 mb-3">
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-2 top-1/2 -translate-y-1/2 text-[#bbb] hover:text-[#777]">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-2 top-1/2 -translate-y-1/2 text-[#bbb] hover:text-[#777]">
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        <button type="button" onClick={() => setRole('freelancer')}
                                                className={`flex items-center justify-center gap-1.5 py-1.5 px-3 rounded-lg border-2 text-[12px] font-medium transition-all ${role === 'freelancer' ? 'border-[#0F5525] bg-[#E1F5EE] text-[#0F5525]' : 'border-[#eee] bg-white text-[#555] hover:border-[#ccc]'}`}>
                                            <i className="ti ti-user-star text-[13px]" aria-hidden="true" />
                                            Freelancer
                                        </button>
                                        <button type="button" onClick={() => setRole('client')}
                                                className={`flex items-center justify-center gap-1.5 py-1.5 px-3 rounded-lg border-2 text-[12px] font-medium transition-all ${role === 'client' ? 'border-[#0F5525] bg-[#E1F5EE] text-[#0F5525]' : 'border-[#eee] bg-white text-[#555] hover:border-[#ccc]'}`}>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <button onClick={handleSuccess} className="flex items-center justify-center gap-2 py-1.5 px-2.5 rounded-lg border border-[#dde3e0] bg-white text-[13px] font-medium text-[#222] transition-colors hover:bg-[#3FCD6B] hover:border-[#3FCD6B] hover:text-white">
                    ...
                    {activePanel === 'success' && (
                        <div>
                            <div className="pt-5 px-6 pb-2">
                                <div className="text-[17px] font-semibold text-[#111] mb-0.5">Account created!</div>
                            </div>
                            ...
                            <div className="px-6 pb-5 text-center py-3">
                                ...
                                <div className="h-1 bg-[#eee] rounded-full overflow-hidden">
                                    <div className="h-full bg-[#3FCD6B] rounded-full transition-all duration-2500 ease-linear" style={{ width: `${redirectProgress}%` }} />
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    {activePanel === 'forgot' && (
                        <div>
                            <div className="pt-5 px-6 pb-2">
                                <div className="text-[17px] font-semibold text-[#111] mb-0.5">Reset your password</div>
                                <div className="text-[12px] text-[#777]">Enter your email and we&#39;ll send a reset link</div>
                            </div>
                            ...
                            <div className="px-6 pb-5">
                                ...
                                <div onClick={() => setActivePanel('login')} className="text-[12px] text-[#aaa] cursor-pointer flex items-center gap-1 mt-3 justify-center transition-colors hover:text-[#3FCD6B]">
